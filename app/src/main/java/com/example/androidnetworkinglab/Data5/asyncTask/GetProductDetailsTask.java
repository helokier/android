...
import android.os.AsyncTask; import android.widget.EditText;
...
// Building Parameters
        ...
        try {
            ...
            // json success tag
            int success = json.getInt(Constants.TAG_SUCCESS); if(success == 1){
                JSONArray productObj = json.getJSONArray(Constants.TAG_PRODUCT);
                // get first product object from JSON Array
                JSONObject obj = productObj.getJSONObject(0);
                // product with this pid found
                product = new Product(); product.setName(obj.getString(Constants.TAG_NAME));
