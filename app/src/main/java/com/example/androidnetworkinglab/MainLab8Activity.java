...
public class MainLab8Activity extends AppCompatActivity {
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(MainLab8Activity.this,
                            Lab8Activity.class));
                    finish();
                }
            }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                               ...
                                                               public void onComplete(@NonNull Task<Void>
                                                                   ...
                                                                   if (task.isSuccessful()) {
                                                                       Toast.makeText(MainLab8Activity.this,
                                                               ...
                                                               OnCompleteListener<Void>() {
                                                                   ...
                                                                   public void onComplete(@NonNull
                                                                       ...
                                                                       if (task.isSuccessful()) {
                                                                           ...
                                                                           Toast.makeText(MainLab8Activity.this, "Password is updated, sign in with new password!", Toast.LENGTH_SHORT).show();

                                                                           signOut();
                                                                           progressBar.setVisibility(View.GONE);
                                                                       } else {

                                                                           Toast.makeText(MainLab8Activity.this, "Failed to update password!",
                                                               ...
                                                               public void onComplete(@NonNull Task<Void>
                                                                   ...
                                                                   if (task.isSuccessful()) {
                                                                       Toast.makeText(MainLab8Activity.this,
                                                                               ...
                                                                               Toast.LENGTH_SHORT).show();
                                                                       startActivity(new
                                                                               Intent(MainLab8Activity.this, Lab8Activity.class));
                                                                       finish();
                                                                       progressBar.setVisibility(View.GONE);
                                                                   } else {
                                                                       Toast.makeText(MainLab8Activity.this,
